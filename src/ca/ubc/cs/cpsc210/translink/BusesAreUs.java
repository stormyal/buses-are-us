...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public static final String TRANSLINK_API_KEY = "bGGxYB5hwh1pK0cNykSI";
    ...
    public void onLocationChanged(Stop nearest, LatLon locn) {
        if (nearest == null) {
            ...
            CharSequence charSequence = nearest.getNumber() + " " + nearest.getName();
            nearestStopLabel.setText(charSequence);
        }
    }
